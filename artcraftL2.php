            ...
            <div class="col-lg-8">
                <div class="courses-details">
                    <div class="courses-card">
                        <h2>Diploma Programs- DRAW & COLOR</h2>
                        <div class="img">
                            ...
                            <ul>
                                <li>
                                    <div class="teacher">
                                        ...
                                        <p>Diploma Programs: <a href="#">DRAW & COLOR</a></p>
                                    </div>
                                </li>
                        ...
                        <div class="container p-0">
                            ...
                            <div class="tab-content" id="nav-tabContent">
                                <div class="tab-pane fade show active" id="nav-overview" role="tabpanel" aria-labelledby="nav-overview-tab">
                                    <div class="overview">
                                        <div class="learn">
                                            <h3>Welcome to the Draw & Color Diploma Programs!</h3>
                                            <p>Unlock your creativity and enhance your artistic skills with our comprehensive Draw & Color Diploma Programs. This 2-month course is designed for individuals of all skill levels, from complete beginners to intermediate artists looking to refine their techniques.</p>
