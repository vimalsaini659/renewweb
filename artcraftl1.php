            ...
            <div class="col-lg-8">
                <div class="courses-details">
                    <div class="courses-card">
                        <h2>Diploma Programs- ART & CRAFT L-1</h2>
                        <div class="img">
                            ...
                            <ul>
                                <li>
                                    <div class="teacher">
                                        ...
                                        <p>Diploma Programs: <a href="#">ART & CRAFT L-1</a></p>
                                    </div>
                                </li>
                                <li><i class="flaticon-clock"></i><span>Course: </span>ART & CRAFT L-1</li>
                            </ul>
                        </div>
                    </div>
                        ...
                        <div class="container p-0">
                            ...
                            <div class="tab-content" id="nav-tabContent">
                                <div class="tab-pane fade show active" id="nav-overview" role="tabpanel" aria-labelledby="nav-overview-tab">
                                    <div class="overview">
                                        <div class="learn">
                                            <h3>Welcome to the ART & CRAFT L-1 Diploma Programs!</h3>
                                            <p>Unlock your creativity and enhance your artistic skills with our comprehensive ART & CRAFT L-1 Diploma Programs. This 2-month course is designed for individuals of all skill levels, from complete beginners to intermediate artists looking to refine their techniques.</p>
                                ...
                                <div class="tab-pane fade" id="nav-reviews" role="tabpanel" aria-labelledby="nav-reviews-tab">
                                    <div class="reviews">
                                        ...
                                        <div class="single-reviews-card">
                                            ...
                                            <p>The ART & CRAFT L-1 class at GIFA was an amazing experience! The instructor was very knowledgeable and provided excellent guidance throughout the course. I started as a complete beginner, and by the end, I was able to create detailed and colorful drawings. The hands-on practice sessions were incredibly helpful, and I loved exploring different coloring techniques. Highly recommend!</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
