...
<section class="course" style="margin-top: 51px;">
        <div class="container">
            <div class="row">
                ...
                <div class="gallery_product col-lg-3 col-md-3 col-sm-3 col-xs-6 filter entrance">
                    <div class="single-courses-card style2">
                        <div class="courses-img">
                            <a href="IgniteYourAmbition.php"><img src="assets/images/newimages/ent-1.png" alt="Image"></a>
                        </div>
                        <div class="courses-content">
                            <div class="admin-profile">
                                <!-- <img src="assets/images/courses/admin-1.jpg" alt="Image"> -->
                                <p><a href="IgniteYourAmbition.php">Entrance Exam</a></p>
                            </div>
                            <a href="#">
                            ...
                            <div class="bottom-content">
                                <ul class="d-flex justify-content-between">
                                    ...
                                    <li><a href="IgniteYourAmbition.php">View</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
