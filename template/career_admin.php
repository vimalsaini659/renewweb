           ...
           <tr>
              <td bgcolor="#F7F9F9">
                 <table style="width:100%;clear:both" border="0" align="center" cellpadding="0" cellspacing="0">
                    ...
                    <tr> 
                    <td style="color:#101010;font-size:1rem;"><strong>Job profile:</strong> </td>
                    <td style="color:#101010;font-size:1rem;">' . $cr_profile . '</td>
                 </tr>
                    <tr> 
                          <td style="color:#101010;font-size:1rem;"><strong>Message:</strong> </td>
                          <td style="color:#101010;font-size:1rem;">' . $cr_msg . '</td>
                       </tr>
