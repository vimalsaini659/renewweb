...
<div class="modal fade" id="addDownload">
          	...
          	<div class="modal-body">
            	...
            	<form class="form-horizontal" method="POST" action="admin_user_add.php" enctype="multipart/form-data">
          		  ...
          		  <div class="form-group">
                  	...
                  	<label for="titlename" class="col-sm-3 control-label">Title Name</label>
                ...
                <div class="form-group">
                  	...
                  	<label for="photo" class="col-sm-3 control-label">File Upload</label>
