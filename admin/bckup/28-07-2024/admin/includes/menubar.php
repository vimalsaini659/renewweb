<aside class="main-sidebar">
  ...
  <section class="sidebar">
    ...
    <ul class="sidebar-menu" data-widget="tree">
      ...
      <li><a href="e_book.php"><i class="fa fa-envelope"></i> <span>E-Bookold</span></a></li>
      <li><a href="ebook.php"><i class="fa fa-book"></i> <span>E-Book</span></a></li>
      <li><a href="scr.php"><i class="fa fa-calendar"></i> <span>RFC</span></a></li>
      <li><a href="job_apply.php"><i class="fa fa-user-circle"></i> <span>Job Application</span></a></li>
      <li><a href="download.php"><i class="fa fa-cloud-download"></i> <span>Download</span></a></li>
    </ul>
    <!--li class="treeview">
