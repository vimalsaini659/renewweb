                        ...
                        <tr>
                          ...
                          <td>
                            ...
                            <?php if ($row['isactive'] == 0) {
                              //echo 'Active';
                            ?>
                              <button class="btn btn-success btn-sm btnUpdateUserStatus" id="<?php echo $row['id']; ?>" data-status="1">Active</button>
                            <?php
                            } else {
                            ?>
                              <button class="btn btn-danger btn-sm btnUpdateUserStatus" id="<?php echo $row['id']; ?>" data-status="0">InActive</button>
                            <?php
                            } ?>
